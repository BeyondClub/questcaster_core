  ...
  return (
    <>
      <dialog id='username_modal' className='modal'>
        <div className='modal-box max-w-sm border border-gray-400'>
      ...
      <form onSubmit={addDataToVercelDB}>
        ...
        <div className='mt-3'>
          {follow && (
            <div className='w-full p-3 bg-black border border-gray-400 px-4 flex justify-between items-center mt-2'>
